...
export default {
  ...
  data() {
    return {
      ...
      tabs: [headlessTypes.PLAYWRIGHT, headlessTypes.PUPPETEER, headlessTypes.MIDSCENE],
    }
  },

  computed: {
    code() {
      if (this.activeTab === headlessTypes.PUPPETEER) return this.puppeteer
      if (this.activeTab === headlessTypes.PLAYWRIGHT) return this.playwright
      return this.midscene
    },
  },
